package com.dyz.demo.rabbitmq.basic;
...
//                false, // autoDelete 自动删除，前提是该队列没有消费者绑定且队列中没有消息
//                null);
...
//                "test-queue-1", // 队列
//                false, // auto ack 自动确认
//                "tag1-reject", // consumer tag 用于区分消费者
//                false, // noLocal true，表示不能将同一个connection中生产者发送的消息传递给这个Connection中的消费者
//                // AMQP标准，但是rabbitmq没有实现
//                false, // exclusive 排他消费者，该队列只接受一个消费者
//                null, // Map<String, Object> arguments
//                new RejectConsumer(channel, "consumer-reject-1") // consumer
//        );

//        channel.basicConsume(
//                "test-queue-1", // 队列
//                false, // auto ack 自动确认
//                "tag2", // consumer tag 用于区分消费者
//                false, // noLocal true，表示不能将同一个connection中生产者发送的消息传递给这个Connection中的消费者
//                // AMQP标准，但是rabbitmq没有实现
//                false, // exclusive 排他消费者，该队列只接受一个消费者
//                null, // Map<String, Object> arguments
